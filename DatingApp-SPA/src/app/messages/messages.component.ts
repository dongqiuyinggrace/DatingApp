...
export class MessagesComponent implements OnInit {
  ...
  constructor(private authService: AuthService, private altertify: AlertifyService,
              private route: ActivatedRoute, private userSevice: UserService) { }
  ...
  deleteMessage(id: number) {
    this.altertify.confirm('Are you sure to delete this message?', () => {
      this.userSevice.deleteMessage(id, this.authService.decodedToken.nameid).subscribe(() => {
        ...
        this.altertify.success('Message has been deleted');
      }, error => {
        this.altertify.error('Failed to delete this message');
      });
    });
  }
